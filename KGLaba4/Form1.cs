...
namespace KGLaba4
{
    public partial class Form1 : Form
    {
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            ...
            int g = int.Parse(textBox12.Text);
            int b = int.Parse(textBox11.Text);

            Layout l = new Layout(Color.FromArgb(r,g,b), Color.Black, new List<Point> { new Point(int.Parse(textBox6.Text), int.Parse(textBox5.Text)),
